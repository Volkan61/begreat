...
class DescriptionSerieController extends Controller
{
    /**
...
// more than one foreign key
    ...
    public function update(Request $request, $id)
    {
        ...
        $serie_description = DescriptionSerie::where("serie_id",$id)->first();


        $serie_description->description ="volkan";

        $serie_description->save();
